...
void MyListCtrl::OnNMClick(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	::SendMessageA(GetParent()->GetSafeHwnd(), WM_WND_MSG, (WPARAM)2, (LPARAM)pNMLV->iItem);
...
void MyListCtrl::OnLvnItemchanged(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	////第几项
	//::SendMessageA(GetParent()->GetSafeHwnd(), WM_WND_MSG, (WPARAM)2, (LPARAM)"1111");
